...
let inline object (tuples: (string * Json) seq) = Object ^ Map.ofSeq tuples

/// Create a Json Object from a string.
let inline string (str: string) = String str

/// Create a Json object from a sequence.
let inline array (lst: Json seq) = lst |> Seq.toList |> Array
